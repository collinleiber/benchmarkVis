...
#' @param violin if set to TRUE a violin plot instead of boxplot is produced (facetting.problem should be FALSE)
...
#' createBoxPlot(mlr.benchmark.example, 'measure.mmce.test.mean', facetting.problem = TRUE)
createBoxPlot = function(dt, measure, violin = FALSE, facetting.problem = FALSE) {
